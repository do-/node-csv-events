...
class CSVReader extends Transform {
	...
	#rowNum
	get rowNum ( ) {return this.#rowNum}
	set rowNum (v) {       this.#rowNum = v; this.record = this.newRecord ()}
	...
	constructor (options) {
		...
		if (typeof options.rowNumField === 'string') options.setRowNum = (o, v) => o [options.rowNumField] = v
		...
		csv.on ('r', () => {
			...
			if (options.setRowNum) options.setRowNum (this.record, this.rowNum)
